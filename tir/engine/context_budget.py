...
from tir.config import (
    PROMPT_BUDGET_WARNING_CHARS_CONFIG,
    RETRIEVED_CONTEXT_BUDGET_CHARS,
)

AUTO_RETRIEVAL_RESULTS = 8
RETRIEVED_CONTEXT_CHAR_BUDGET = RETRIEVED_CONTEXT_BUDGET_CHARS
PROMPT_BUDGET_WARNING_CHARS = PROMPT_BUDGET_WARNING_CHARS_CONFIG
