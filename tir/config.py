...
IMAGE_GENERATION_DEFAULT_WIDTH = _env_int(
    "ANAM_IMAGE_GENERATION_DEFAULT_WIDTH",
    int(_IMAGE_GENERATION_CONFIG.get("default_width", 512)),
)
IMAGE_GENERATION_DEFAULT_HEIGHT = _env_int(
    "ANAM_IMAGE_GENERATION_DEFAULT_HEIGHT",
    int(_IMAGE_GENERATION_CONFIG.get("default_height", 512)),
)
